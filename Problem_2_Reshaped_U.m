...
O1= imresize( double( rgb2gray( imread('yaleB05','jpeg') ) ) , [120 80] );
O2= imresize( double( rgb2gray( imread('yaleB06','jpeg') ) ) , [120 80] );
O3= imresize( double( rgb2gray( imread('yaleB07','jpeg') ) ) , [120 80] );
O4= imresize( double( rgb2gray( imread('yaleB08','jpeg') ) ) , [120 80] );
O5= imresize( double( rgb2gray( imread('yaleB09','jpeg') ) ) , [120 80] );

M1= imresize( double( rgb2gray( imread('yaleB10','jpeg') ) ) , [120 80] );
M2= imresize( double( rgb2gray( imread('yaleB11','jpeg') ) ) , [120 80] );
M3= imresize( double( rgb2gray( imread('yaleB12','jpeg') ) ) , [120 80] );
M4= imresize( double( rgb2gray( imread('yaleB13','jpeg') ) ) , [120 80] );
M5= imresize( double( rgb2gray( imread('yaleB14','jpeg') ) ) , [120 80] );

F1= imresize( double( rgb2gray( imread('yaleB15','jpeg') ) ) , [120 80] );
F2= imresize( double( rgb2gray( imread('yaleB16','jpeg') ) ) , [120 80] );
F3= imresize( double( rgb2gray( imread('yaleB17','jpeg') ) ) , [120 80] );
F4= imresize( double( rgb2gray( imread('yaleB18','jpeg') ) ) , [120 80] );
F5= imresize( double( rgb2gray( imread('yaleB19','jpeg') ) ) , [120 80] );

A1= imresize( double( rgb2gray( imread('yaleB20','jpeg') ) ) , [120 80] );
A2= imresize( double( rgb2gray( imread('yaleB21','jpeg') ) ) , [120 80] );
A3= imresize( double( rgb2gray( imread('yaleB22','jpeg') ) ) , [120 80] );
A4= imresize( double( rgb2gray( imread('yaleB23','jpeg') ) ) , [120 80] );
A5= imresize( double( rgb2gray( imread('yaleB24','jpeg') ) ) , [120 80] );

B1= imresize( double( rgb2gray( imread('yaleB25','jpeg') ) ) , [120 80] );
B2= imresize( double( rgb2gray( imread('yaleB26','jpeg') ) ) , [120 80] );
B3= imresize( double( rgb2gray( imread('yaleB27','jpeg') ) ) , [120 80] );
B4= imresize( double( rgb2gray( imread('yaleB28','jpeg') ) ) , [120 80] );
B5= imresize( double( rgb2gray( imread('yaleB29','jpeg') ) ) , [120 80] );

D1= imresize( double( rgb2gray( imread('yaleB30','jpeg') ) ) , [120 80] );
D2= imresize( double( rgb2gray( imread('yaleB31','jpeg') ) ) , [120 80] );
D3= imresize( double( rgb2gray( imread('yaleB32','jpeg') ) ) , [120 80] );
D4= imresize( double( rgb2gray( imread('yaleB33','jpeg') ) ) , [120 80] );
D5= imresize( double( rgb2gray( imread('yaleB34','jpeg') ) ) , [120 80] );

E1= imresize( double( rgb2gray( imread('yaleB35','jpeg') ) ) , [120 80] );
E2= imresize( double( rgb2gray( imread('yaleB36','jpeg') ) ) , [120 80] );
E3= imresize( double( rgb2gray( imread('yaleB37','jpeg') ) ) , [120 80] );
E4= imresize( double( rgb2gray( imread('yaleB38','jpeg') ) ) , [120 80] );
E5= imresize( double( rgb2gray( imread('yaleB39','jpeg') ) ) , [120 80] );
...
%plot the reshaped columns of U
%[U,S,V]=svd(C)
